...
export const TEKKEN_7_COMBO_MAP_TRANSLATION = {
  ...
  DF: { imagePath: '/tekken7/moves/dfp.svg', action: TEKKEN_7_COMBO_MAP.DF },
  DB: { imagePath: '/tekken7/moves/dbp.svg', action: TEKKEN_7_COMBO_MAP.DB },
  UF: { imagePath: '/tekken7/moves/ufp.svg', action: TEKKEN_7_COMBO_MAP.UF },
  UB: { imagePath: '/tekken7/moves/ubp.svg', action: TEKKEN_7_COMBO_MAP.UB },
  'd/f': { imagePath: '/tekken7/moves/df.svg', action: TEKKEN_7_COMBO_MAP.df },
  'd/b': { imagePath: '/tekken7/moves/db.svg', action: TEKKEN_7_COMBO_MAP.db },
  'u/f': { imagePath: '/tekken7/moves/uf.svg', action: TEKKEN_7_COMBO_MAP.uf },
  'u/b': { imagePath: '/tekken7/moves/ub.svg', action: TEKKEN_7_COMBO_MAP.ub },
  'D/F': { imagePath: '/tekken7/moves/dfp.svg', action: TEKKEN_7_COMBO_MAP.DF },
  'D/B': { imagePath: '/tekken7/moves/dbp.svg', action: TEKKEN_7_COMBO_MAP.DB },
  'U/F': { imagePath: '/tekken7/moves/ufp.svg', action: TEKKEN_7_COMBO_MAP.UF },
  'U/B': { imagePath: '/tekken7/moves/ubp.svg', action: TEKKEN_7_COMBO_MAP.UB },
  'S!': {
