...
@Service
@Slf4j
public class PlaylistComboService {
	...
	public List<Combo> addAllCombosToPlaylist(
		...
		if ((!comboIds.isEmpty() && combos.isEmpty()) ||
	...
	public List<Combo> removeCombosFromPlaylist(
		...
		List<PlaylistCombo> playlistCombos = this.playlistComboRepository.findAllByIdInAndPlaylist(
				playlistComboIds,
				playlist);
